...
public class BuyNowPage extends Page {
	...
	public boolean buttonsInOneLine() {
		...
		return (buyNowButtonOnBuyNowPage.getLocation().y == contactUsInstantShareButtonOnBuyNowPage
				.getLocation().y && buyNowButtonOnBuyNowPage.getLocation().y == contactUsQuatrixButtonOnBuyNowPage
				.getLocation().y);
	}
